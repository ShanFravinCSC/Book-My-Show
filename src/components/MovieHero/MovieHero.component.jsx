        ...
        <>
            <diV>
                ...
                >
                    ...
                    <div className="w-full h-56 absolute bg-black z-10 bg-opacity-50 bottom-0" />
                        <img
                ...
                {/*Tab*/}
                <div className="relative hidden lg:hidden md:block w-full" style={{ height: "calc(100vw)"}}>
                <div className="w-full h-56 absolute bg-black z-10 bg-opacity-50 bottom-0" />
