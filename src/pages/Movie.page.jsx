...
//config
//mport TempPosters from "../config/TempPosters.config";
    ...
    return (
        <>
            ...
            <div className="my-8">
                ...
                <div className="flex item-start gap-2 bg-yellow-200 p-3 border-yellow-400 border-dashed border-2 rounded-md">
